                        ...
                        <div className="flex flex-row flex-wrap  ">
                            ...
                            <div className="flex w-full flex-wrap items-end gap-4 px-4 py-3 ">
                                <label className="flex flex-col min-w-40  flex-1">
                                    <p className="text-[#0f111a] text-base text-left font-medium leading-normal pb-2">Content</p>
                                    <textarea
                                        placeholder="Start writing your note here..."
                                        className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#0f111a] focus:outline-0 focus:ring-0 border border-[#d2d6e4] bg-[#e6e9f4] focus:border-[#d2d6e4] placeholder:text-[#56618f] p-[15px] text-base font-normal leading-normal"
                                        value={content}
                            ...
                            <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                                <label className="flex flex-col min-w-40 flex-1">
                                    <p className="text-[#0f111a] text-base font-medium leading-normal text-left pb-2">Image</p>
                                    <input
                                        type="file"
                                        accept="image/*"
                                        className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#0f111a] focus:outline-0 focus:ring-0 border border-[#d2d6e4] bg-[#e6e9f4] focus:border-[#d2d6e4] h-14 placeholder:text-[#56618f] p-[15px] text-base font-normal leading-normal"
                                        value={img}
