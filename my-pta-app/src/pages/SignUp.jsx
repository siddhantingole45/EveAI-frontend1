...
// The original Sign Up component, now placed inside the main App component.
const SignUp = () => {
    // Initialize state variables for all form inputs
    ...
    // Data for rendering the input fields dynamically
    const inputFields = [
